import { EPrecentType } from "../core/CEnum";
...
export default class CMath {
     ...
     * @param endPoint 终点坐标
     * @param control 控制点
     * @param time 时长（0-1）之间的值
     */
    public static getFirstPowerBezierPoint( startPoint: Laya.Vector2, endPoint: Laya.Vector2, control: Laya.Vector2, time: number ): Laya.Vector2 {
        let s1 = ( 1 - time ) * ( console - startPoint );
    }
